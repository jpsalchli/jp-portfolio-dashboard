...
try:
    ...
    st.warning("Some sections failed to load due to rate limits or missing data.")
...
try:
    ...
    st.error(f"Failed to load stock data: Too Many Requests. Rate limited. Try after a while.")
